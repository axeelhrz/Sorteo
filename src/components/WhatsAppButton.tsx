...
const WHATSAPP_NUMBER = (process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || '984908819').replace(/\D/g, '');
const WHATSAPP_URL = `https://wa.me/51${WHATSAPP_NUMBER}?text=${encodeURIComponent(
